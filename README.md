...
- **`docs/DECISIONS.md`** — Decision log (31 ADRs: anchoring, measurement, stats, auth, Google federation + email identity + password reconstruction, layout, import/export, content whitespace normalization, forgiving mode, immersive refocus + caret under pinch-zoom, custom domain, Sentry, privacy).
